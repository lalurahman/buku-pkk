...
@section('title', 'Detail Akun Desa')
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Detail Akun Desa</h4>
            ...
            <div>
                <a
                    href="{{ route('admin.user.villages.edit', $user->id) }}"
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label text-muted">Desa</label>
